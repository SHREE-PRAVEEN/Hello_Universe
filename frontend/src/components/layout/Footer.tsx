      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-zinc-600 dark:text-zinc-400">
              Pioneering the future of robotics with AI-powered automation and blockchain technology.
            </p>
            ...
            <div className="mt-6 flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-white"
            ...
            <ul className="mt-4 space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-zinc-600 transition-colors hover:text-cyan-500 dark:text-zinc-400 dark:hover:text-cyan-400"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-zinc-200 pt-8 dark:border-zinc-800 md:flex-row">
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            © {new Date().getFullYear()} Hello Universe. All rights reserved.
          </p>
